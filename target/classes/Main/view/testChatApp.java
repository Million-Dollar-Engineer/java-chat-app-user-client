 ...
 * @author HP-PC
 */
public class testChatApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Bao Pham Hong Gia", "Phan Thanh An", "Bao Pham Hong Gia", "Phan Thanh An" };
...
//        JLabel label = new JLabel(getMess);
//        area.add(label);
//        sendMessage.setText("");
...
//        area.add(label3);
    ...
    // Create a JPanel as a wrapper for the area component
    JPanel areaWrapper = new JPanel();
    areaWrapper.setLayout(new FlowLayout());

    areaWrapper.add(label);

    // Add the wrapper panel to the desired container
    // Assuming `container` is the container where you want to add the labels
    area.add(areaWrapper);
    ...
    areaWrapper.add(label1);
    areaWrapper.add(label2);
    areaWrapper.add(label3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testChatApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new testChatApp().setVisible(true);
            }
        });
    }
